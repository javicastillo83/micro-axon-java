package com.sbaxon.domain.client;

import com.sbaxon.domain.client.event.CreateClientEvent;
import com.sbaxon.domain.client.event.SubscribeProductEvent;
import com.sbaxon.domain.client.event.UnSubscribeProductEvent;
import com.sbaxon.domain.client.event.UpdateClientEvent;
